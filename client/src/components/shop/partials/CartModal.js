...
import { cartList } from "../product/Mixins";
import {  quantity } from "./Mixins";
      ...
      <section className={`${!data.cartModal ? "hidden" : ""} fixed z-40 inset-0 flex items-start justify-end`}>
        ...
        >
          ...
          <div className="m-4 space-y-4">
            <div
              onClick={(e) => cartModalOpen()}
              className="cursor-pointer px-4 py-2 border border-gray-400 text-white text-center cursor-pointer" style={{background:'#0055A1'}}
            >
              Continue shopping
              ...
              <Fragment>
                {isAuthenticate() ? (
                    <div
                        className="px-4 py-2 bg-black text-white text-center cursor-pointer"  style={{background:'#E6A821'}}
                        onClick={(e) => {
